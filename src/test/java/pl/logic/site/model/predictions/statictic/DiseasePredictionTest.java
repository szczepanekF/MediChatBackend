...
class DiseasePredictionTest {
    ...
    void setUp() throws ParseException {
        ...
        Disease disease_4 = new Disease(8, "otitis");
        Disease disease_5 = new Disease(5, "otitis");
        ...
        Patient patient_5 = new Patient(5, "Wiktor", "Orkczan", birth_date_2, 165, 58, "female", status, "cm", "kg");
        ...
        this.testingSet.add(new DiseaseVector(disease_4, patient_4, result_4));
        this.testingSet.add(new DiseaseVector(disease_5, patient_5, result_5));
        this.testingSet.add(new DiseaseVector(null, patient_1, result_2));
    ...
    void getPrediction() {
        ...
        String mostCommonDisease = (String) diseasePrediction.getPrediction(results);

        System.out.println(mostCommonDisease);
        assertEquals("otitis", mostCommonDisease);
    }
}